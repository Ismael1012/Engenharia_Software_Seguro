...
A principal dificuldade foi atribuir probabilidades realistas sem histórico operacional e distinguir controles propostos de controles cuja eficácia já tivesse sido comprovada. Para evitar uma falsa precisão, o grupo registrou as premissas de cada nota e tratou os níveis residuais apenas como estimativas condicionadas à implementação e aos testes.
